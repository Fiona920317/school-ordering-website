<template>
  ...
  >
    <div class="loginBackground ms-3 me-3 mb-3">
      ...
      <div class="loginContent">
        ...
        <p class="loginContent__text">
          登入即表示你同意我們的<span class="fw-bold text-decoration-underline"
            ><a href="">使用者條款</a></span
          >與<span class="fw-bold text-decoration-underline"
            ><a href="">隱私權政策</a></span
          >。
        </p>
      </div>
